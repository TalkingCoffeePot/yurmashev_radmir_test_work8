...
from products.views import ProductListView, ProductDetailedView, ProductCreateView, ProductUpdateView, ProductDeleteView, ModerateViews
...
urlpatterns = [
    ...
    path('products/<int:product_pk>', ProductDetailedView.as_view(), name='detailed_product'),
